...
- jarvis.trackers's "custom" category + "University" list_name (Step 4).
- jarvis.tools.calendar_auth.get_calendar_service() — the SAME Google
...
- jarvis.guc.dedupe for duplicate checking against the local tracker.
...
def approve_review_item(item_id: str) -> dict:
    ...
    jarvis.trackers has no update-tags primitive and adding one wasn't
