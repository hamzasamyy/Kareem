"""Per-launch conversation logging for Jarvis.
...
allowed to interrupt a Jarvis conversation.
"""
...
def _clear_readonly(func, path, exc_info):
    ...
    Jarvis process) end up marked read-only on Windows, which blocks deletion
