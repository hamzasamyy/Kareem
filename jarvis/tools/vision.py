...
0-2 (jarvis/tools/apps.py's navigate_app, jarvis/tools/browser.py's DOM-
based browser control, jarvis/tools/app_control.py's UI-Automation-based
...
notice" — see jarvis/config.py's VISION_MODEL comment). Pixel-based
...
easy to see how often Jarvis actually needed this vs. the more reliable
layers.
"""
...
def _ask_vision_model(image_b64: str, description: str) -> dict:
    ...
    Jarvis. Deliberately a ONE-shot call with no internal retry loop: a
    ...
    from jarvis.brain import strip_think
...
def vision_click(description: str) -> str:
    from jarvis.safety import refuse_if_hard_blocked_click
    ...
    from jarvis.safety import classify_click_intent, guard
