' ============================================================================
'  run_kareem_silent.vbs  --  Start Kareem in the BACKGROUND with NO window,
...
'  silent launch. Output goes to kareem_background.log in this folder; quit from
...
'  the same reason run_kareem.bat exists for the normal foreground launch.
' ============================================================================
Option Explicit
...
If Not fso.FileExists(pyw) Then
    MsgBox "Kareem: Python 3.12 was not found at:" & vbCrLf & pyw & vbCrLf & vbCrLf & _
           "Install Python 3.12, or edit the 'pyw' line in run_kareem_silent.vbs " & _
           "to point at your pythonw.exe.", vbExclamation, "Kareem launcher"
    WScript.Quit 1
End If
