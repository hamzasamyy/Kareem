...
from jarvis.agent import SYSTEM_PROMPT, SYSTEM_PROMPT_SMALL
...
class SystemPromptWordingTests(unittest.TestCase):
    ...
    def test_time_sensitivity_instruction_still_present(self):
        ...
        # query got no search at all and Jarvis hallucinated a stale-
    ...
    def test_small_prompt_variant_has_short_exception_too(self):
        ...
        # hosted brain (see jarvis/brain.py's _fallback_to_ollama), so it
    ...
    def test_small_prompt_variant_stays_short(self):
        ...
        # in jarvis/agent.py): qwen2.5:3b answers silently empty when the
