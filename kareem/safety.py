"""
Safety gate — every risky/destructive action Kareem can take must be routed
...
Edit RISKY_PATTERNS to change what Kareem treats as dangerous.
"""
...
logger.propagate = False  # keep library noise (httpx etc.) out of kareem.log
...
def log_action(action: str, detail: str = "", confirmed: bool | None = None):
    """Write a line to kareem.log describing an action Kareem took (or was asked to take)."""
    status = ""
...
# what Kareem treats as "risky" — this list is meant to be edited by you.
RISKY_ACTIONS = {
...
# from RISKY_ACTIONS above: no confirmation can unlock them, because Kareem
...
# browser_click/app_click/vision_click tools (kareem/tools/browser.py,
...
# The voice path (kareem/voice/controller.py::_voice_confirm) already
