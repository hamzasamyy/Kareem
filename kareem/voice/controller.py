...
class VoiceController:
    ...
    def start(self) -> bool:
        ...
        # --- speaking ---
        try:
            from kareem.voice.tts import Speaker
        ...
        threading.Thread(target=_prewarm_stt, daemon=True, name="kareem-stt-warmup").start()
    ...
    def speak_reply(self, text: str):
        ...
        speakers are on so Kareem can't trigger itself."""
    ...
    def _listen_once(self) -> str:
        ...
        from kareem.voice import stt, vad
    ...
    def _handle_interaction(self):
        ...
        try:
            ...
            # False in kareem/config.py for the old talk-out-loud behavior.
